...
deploy-sepolia:
	@forge script script/DeployRaffle.s.sol:DeployRaffleScript --rpc-url $(SEPOLIA_RPC_URL) --account myaccount --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
